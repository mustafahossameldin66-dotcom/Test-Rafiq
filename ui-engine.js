...
async function bootCore(){
  ...
  if('serviceWorker'in navigator&&location.protocol.startsWith('http'))navigator.serviceWorker.register('./sw.js?v=86',{updateViaCache:'none'}).catch(()=>{});
